...
class AppTheme {
  ...
  static final ThemeData lightTheme = ThemeData(
    ...
    navigationRailTheme: NavigationRailThemeData(
        selectedIconTheme:
            IconThemeData(color: Color(0xff5da695), opacity: 1, size: 24),
        unselectedIconTheme:
            IconThemeData(color: Color(0xff495057), opacity: 1, size: 24),
        backgroundColor: Color(0xffffffff),
        elevation: 3,
        selectedLabelTextStyle: TextStyle(color: Color(0xff5da695)),
        unselectedLabelTextStyle: TextStyle(color: Color(0xff495057))),
    colorScheme: ColorScheme.light(
        primary: Color(0xff5da695),
        onPrimary: Colors.white,
        primaryVariant: Color(0xff0055ff),
        secondary: Color(0xff495057),
        secondaryVariant: Color(0xff1b5e20),
    ...
    inputDecorationTheme: InputDecorationTheme(
      ...
      focusedBorder: OutlineInputBorder(
        ...
        borderSide: BorderSide(width: 1, color: Color(0xff5da695)),
      ),
    ...
    highlightColor: Color(0xff5da695),
    floatingActionButtonTheme: FloatingActionButtonThemeData(
        backgroundColor: Color(0xff5da695),
        splashColor: Colors.black.withAlpha(100),
        highlightElevation: 8,
        elevation: 4,
        focusColor: Color(0xff5da695),
        hoverColor: Color(0xff5da695),
        foregroundColor: Colors.black),
    dividerColor: Color(0xffd1d1d1),
    errorColor: Color(0xffb71c1c),
    cardColor: Colors.white,
    accentColor: Color(0xff5da695),
    ...
    tabBarTheme: TabBarTheme(
      ...
      labelColor: Color(0xff5da695),
      indicatorSize: TabBarIndicatorSize.label,
      indicator: UnderlineTabIndicator(
        borderSide: BorderSide(color: Color(0xff5da695), width: 2.0),
      ),
    ),
    sliderTheme: SliderThemeData(
      activeTrackColor: Color(0xff5da695),
      inactiveTrackColor: Color(0xff5da695).withAlpha(140),
      trackShape: RoundedRectSliderTrackShape(),
      trackHeight: 4.0,
      thumbColor: Color(0xff5da695),
  ...
  static ThemeData baseTheme = ThemeData(
      ...
      colorScheme: ColorScheme.dark(
        primary: Color(0xff5da695),
        primaryVariant: Color(0xff5da695),
        secondary: Color(0xff338c77),
        secondaryVariant: Color(0xff338c77),
      ...
      sliderTheme: SliderThemeData(
        activeTrackColor: Color(0xff5da695),
        inactiveTrackColor: Color(0xff5da695).withAlpha(100),
        trackShape: RoundedRectSliderTrackShape(),
        trackHeight: 4.0,
        thumbColor: Color(0xff5da695),
        thumbShape: RoundSliderThumbShape(enabledThumbRadius: 10.0),
  ...
  static NavigationBarTheme getNavigationTheme() {
  ...
  static final CustomAppTheme lightCustomAppTheme = CustomAppTheme(
    ...
    colorSuccess: Color(0xff1b5e20),
    shadowColor: Color(0xffeaeaea),
    onInfo: Color(0xffffffff),
    onSuccess: Color(0xffffffff),
    onWarning: Color(0xffffffff),
    colorError: Color(0xffb71c1c),
    onError: Color(0xffffffff),
  );
  static final CustomAppTheme customAppTheme = CustomAppTheme(
